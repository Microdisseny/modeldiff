...
class ModeldiffTests(TestCase):
    ...
    def setUp(self):
        self.person = PersonModel.objects.create(name='Foo', surname='Doe',
                                   birthdate=date(2007, 12, 5),
                                   updated_at=datetime(2015, 1, 7, 22, 0, 10, 
                                    292032, GMT0()))
        
        self.persongeo = PersonGeoModel.objects.create(name='Foo', surname='Doe',
                                   birthdate=date(2007, 12, 5),
                                   updated_at=datetime(2015, 1, 7, 22, 0, 10, 
                                    292032, GMT0()),
                                   the_geom='POINT (0 0)')
    ...
    def test_update_parent_field_model(self):
        ...
        person_property = PersonPropertyModel.objects.create(person=self.person, 
